...
const mockRooms = [
  {
    id: 'test-room-id-120',
    roomEmail: 'exactum.a120@helsinki.fi',
    displayId: 'A120',
    displayName: 'Exactum, A120, Meeting room, TEST (1)',
    capacity: 1,
    floorNumber: 1,
  ...
  {
    id: 'test-room-id-235',
    roomEmail: 'exactum.a235@helsinki.fi',
    displayId: 'A235',
    displayName: 'Exactum, A235, Meeting room, TEST (2)',
    capacity: 2,
    floorNumber: 2,
    isWheelchairAccessible: true,
    tags: ['CS'],
  ...
  {
    id: 'test-room-id-335',
    roomEmail: 'exactum.a335@helsinki.fi',
    displayId: 'A335',
    displayName: 'Exactum, A335, Meeting room, TEST (3)',
    capacity: 3,
    floorNumber: 3,
    isWheelchairAccessible: true,
    tags: ['MATHSTAT'],
